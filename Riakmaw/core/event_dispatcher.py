...
from Riakmaw import plugin, util
from Riakmaw.error import EventDispatchError
from Riakmaw.listener import Listener, ListenerFunc
from Riakmaw.util.misc import StopPropagation
...
class EventDispatcher(MixinBase):
    ...
    def unregister_listener(self: "Riakmaw", listener: Listener) -> None:
    ...
    def register_listeners(self: "Riakmaw", plug: plugin.Plugin) -> None:
    ...
    def unregister_listeners(self: "Riakmaw", plug: plugin.Plugin) -> None:
    ...
    async def dispatch_missed_events(self: "Riakmaw") -> None:
    ...
    async def dispatch_alert(self: "Riakmaw", invoker: str, exc: BaseException) -> None:
...
```
    ...
    async def log_stat(self: "Riakmaw", stat: str, *, value: int = 1) -> None:
