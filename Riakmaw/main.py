...
def _setup_log() -> None:
    ...
    logfile = logging.FileHandler("Riakmaw.log")
...
def start() -> None:
    ...
    aiorun.run(Riakmaw.init_and_run(Config(), loop=loop), loop=loop if _uvloop else None)
