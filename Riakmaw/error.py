...
class RiakmawException(Exception):
    """Base exception class for Riakmaw"""


class BackupError(RiakmawException):
    """Unexpected backup data type"""


class EventDispatchError(RiakmawException):
    """Exception raised when a dispatcher raised an exception"""


class CommandHandlerError(RiakmawException):
    """Exception raised when the command handler raised an exception."""


class CommandInvokeError(RiakmawException):
    """Exception raised when the command being invoked raised an exception."""


class PluginLoadError(RiakmawException):
    """Base exception class for every Plugin errors"""


class BadArgument(RiakmawException):
